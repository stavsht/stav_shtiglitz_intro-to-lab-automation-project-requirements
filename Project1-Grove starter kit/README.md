...
## Exercise
- pressure value: 100373.00 Pa
- led blinks when: long press on button
- led is constant when: upon entering the mode picker
- buzzer plays when: upon entering the mode picker
